...
if (isset ($_POST['username'])){
	 ...
	 if(!$pass2){ 
       $errorMsg .= ' * Confirm Login Password<br />';        
              ...
              $errorMsg = 'ERROR: The notbot Check field must be cleared to be sure you are notbot<br />';		 
...
<div id="why" style="background-color:#E6F5FF; border:#999 1px solid; padding:12px; display:none; margin-top:8px;">
     Sometime down the road we may offer content that is only suitable for people over 18. We require this information to check your age. <br /><br />We can also use this information to alert your friends to when your birthday is.
          ...
          <tr>
            <td bgcolor="#EFEFEF">Not a Bot Check: <span class="brightRed">*</span></td>
            <td bgcolor="#EFEFEF"><input name="notbotcheck" type="text" class="formFields" id="notbotcheck" value="Please remove all of this text" size="32" maxlength="32" />
              </td>
          </tr>
          <tr>
