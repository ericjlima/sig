...
while($row = mysql_fetch_array($sql)){
	...
	$MemberDisplayList .= '<td><a href="signal_page.php?id=' . $id . '" title="' . $firstname . '"><font size="-2">' . $firstnameCut . '</font></a><br />
	<div style=" height:64px; overflow:hidden;"><a href="signal_page.php?id=' . $id . '"  title="' . $firstname . '">' . $user_pic . '</a></div></td>';
